...
# %%
#create a cubic spline to give continuous data
...
latitude_of_max_value = latitudes_fine[max_value_index]

#plot the spline and the original data
plt.plot(latitudes, values, label='Original Data')
plt.plot(latitudes_fine, values_fine, label='Spline')

plt.xlabel('Latitude')
plt.ylabel('Precipitation')
plt.legend()
plt.title(f"Latitude of Maximum Precipitation: {round(latitude_of_max_value[0],2)}")
# %%
